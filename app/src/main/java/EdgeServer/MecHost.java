...
public class MecHost {
    ...
    private void initializeLocation(){
        double areaLengthX = Config.MAX_X - Config.MIN_X;
        double areaLengthY = Config.MAX_Y - Config.MIN_Y;

        Random random = new Random();
        double locationX = Config.MIN_X + random.nextDouble() * areaLengthX;
        double locationY = Config.MIN_Y + random.nextDouble() * areaLengthY;
