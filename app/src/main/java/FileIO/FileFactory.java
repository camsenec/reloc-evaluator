...
public class FileFactory {
    ...
    public static void saveServerResult(){
       try {
            ...
            PrintWriter p = new PrintWriter(new BufferedWriter(f));
            p.print("numberOfGroups, pubNum, locality, numberOfServers, method, application_id, server_id, x, y, capacity, used, connection, CPUUsage, numberOfMesssgeProcessor, cluster_id, a, b, distance\n");
    ...
    public static void saveClientResult(){
        try {
            ...
            String filename = String.format("client.csv");
            FileWriter f = new FileWriter("./result/" + filename, false);
            PrintWriter p = new PrintWriter(new BufferedWriter(f));
            p.print("numberOfGroups, pubNum, locality, numOfCoop, method, application_id, client_id, x, y, home_id\n");
